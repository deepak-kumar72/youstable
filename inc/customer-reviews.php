                        ...
                        <div class="carousal-cap">
                            ...
                            <div class="bg-customer-review ">
                                ...
                                <p class=" cutomer_review">The Youstable appears to excel in reliability and customer
                                    ...
                                    experience for their clients. Overall, they seem like a dependable choice for
                                    hosting needs.
                                </p>
                                <h5 class="fw-bold">Sudhanshoo Wadekar</h5>
                                <!-- <p class="fw-normal customer-profile m-0">Youtuber | Content Creator</p> -->
                                <img src="assets/img/review-start-img.png" alt="" class="review-star" />
                            </div>
                        </div>
                        ...
                        <div class="carousal-cap">
                            ...
                            <div class="bg-customer-review ">
                                ...
                                <p class=" cutomer_review">Hello everyone,
                                    ...
                                    user experience. Any kind of problem I got throughout this Time period was resolved
                                    by the support team and as compared to others hosting fees is also decent.
                                </p>
                                <h5 class="fw-bold">Lakshya Poptani
                                </h5>
                                <!-- <p class="fw-normal customer-profile m-0">Affiliate Marketer</p> -->
                        ...
                        <div class="carousal-cap">
                            ...
                            <div class="bg-customer-review ">
                                ...
                                <p class=" cutomer_review">As a Web Development and SEO agency owner, I give YouStable
                                    ...
                                    have boosted my business to greater heights. Their reliable Servers have enhanced my
                                    client’s site Performance exceptionally.
                                </p>
                                <h5 class="fw-bold">Mohd. Zayeem Raza</h5>
                                <!-- <p class="fw-normal customer-profile m-0">Blogger</p> -->
                                <img alt="" src="assets/img/review-start-img.png" class="review-star" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="carousal-cap">
                            ...
                            <div class="bg-customer-review ">
                                ...
                                <p class=" cutomer_review">I’ve been using YouStable to host my website and I’m
                                    ...
                                    Support Executive Ranjan is really helpful and always available plus quick to
                                    respond. Keep it Up!
                                </p>
                                <h5 class="fw-bold">Sahil Saini
                                </h5>
                                <!-- <p class="fw-normal customer-profile m-0">Social Entrepreneur</p> -->
                                <img alt="" src="assets/img/review-start-img.png" class="review-star" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="carousal-cap">
                            ...
                            <div class="bg-customer-review ">
                                ...
                                <p class=" cutomer_review">Youstable.com has been my go-to for 4 years. Fast, reliable
                                    ...
                                    especially Isha, who goes above and beyond. Highly recommend!

                                </p>
                                <h5 class="fw-bold">Akshay Lokhande</h5>
                                <!-- <p class="fw-normal customer-profile m-0">Domain Consultant</p> -->
                                <img alt="" src="assets/img/review-start-img.png" class="review-star" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="carousal-cap">
                            ...
                            <div class="bg-customer-review ">
                                ...
                                <p class=" cutomer_review">Thanks, Team YouStable! Your exceptional hosting delivers
                                    ...
                                    especially Miss Isha Pandey, ensures swift issue resolution. Highly recommended for
                                    reliability, speed, and outstanding care!
                                </p>
                                <h5 class="fw-bold">GAJRAJ BALAI
                                </h5>
                                <!-- <p class="fw-normal customer-profile m-0">Corporate Lawyer</p> -->
                                <img alt="" src="assets/img/review-start-img.png" class="review-star" />
                            </div>
                        </div>
                    </div>
